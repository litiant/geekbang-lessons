...
public class DelegatingEntityManager implements EntityManager {
    ...
    private String persistenceMapperLocation;
    ...
    private Properties loadProperties() {
        ...
        try {
            properties.load(this.getClass().getClassLoader().getResourceAsStream(persistenceMapperLocation));
        } catch (IOException e) {
        ...
        for (String propertyName : properties.stringPropertyNames()) {
            ...
            if (property.startsWith("@")) {
                String componentName = property.substring(1);
    ...
    public void setPersistenceMapperLocation(String persistenceMapperLocation) {
        this.persistenceMapperLocation = persistenceMapperLocation;
    }
