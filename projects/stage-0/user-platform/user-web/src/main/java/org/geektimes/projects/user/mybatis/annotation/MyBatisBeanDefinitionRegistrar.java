...
public class MyBatisBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        // 自行添加其他属性
        Object handlerPackage = attributes.get("typeHandlersPackage");
        Object aliasesPackage = attributes.get("typeAliasesPackage");
        beanDefinitionBuilder.addPropertyValue("typeHandlersPackage", handlerPackage);
        beanDefinitionBuilder.addPropertyValue("typeAliasesPackage", aliasesPackage);
